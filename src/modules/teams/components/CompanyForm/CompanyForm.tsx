...
export const CompanyForm: React.FC<CompanyFormProps> = ({
  ...
  const handleSendInvites = () => {
    const validEmails = companyInvites.filter(invite => invite.email.trim());
    console.log('Отправляем приглашения сотрудникам:', validEmails);
        ...
        <div className={css.inviteSection}>
          ...
          <div className={css.inviteActions}>
            <button
              ...
              disabled={!companyInvites.some(invite => invite.email.trim())}
              type="button"
            >
              <Mail size={20} />
